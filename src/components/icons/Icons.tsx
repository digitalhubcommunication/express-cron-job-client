...
export const LockIcon = ({ className = "w-8 md:w-10 lg:w-14 h-8 md:h-10 lg:h-14 mx-auto" }: { className?: string }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const GearIcon = ({ className = "w-8 md:w-10 lg:w-14 h-8 md:h-10 lg:h-14 mx-auto" }: { className?: string }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
...
export const CallIcon = ({ className = "w-8 md:w-10 lg:w-14 h-8 md:h-10 lg:h-14 mx-auto" }: { className?: string }) => {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
