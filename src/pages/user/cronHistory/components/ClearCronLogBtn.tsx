...
import { useClearCronLogMutation } from "@/redux/features/userAction/userActionApi";
...
export default function ClearCronLogBtn({setCurrentPage, setLogs}:Props) {
  const [clearLog, { isLoading }] =  useClearCronLogMutation();
